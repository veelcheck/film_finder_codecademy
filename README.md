...
This is a project using REST API. It shows a random movie withing a chosen genre form the TMDB.  
Many helper functions were handed to me on a plate, I was also guided how to create getGenres(), getMovies() and getMovieInfo().
